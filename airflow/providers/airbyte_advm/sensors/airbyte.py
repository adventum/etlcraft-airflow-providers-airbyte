...
from airbyte_api.models import GetJobRequest, JobStatus
...
class AirbyteJobSensor(BaseSensorOperator):
    ...
    def poke(self, context: 'Context') -> bool:
        ...
        job = hook.get_job(GetJobRequest(job_id=self.airbyte_job_id))
        ...
        elif JobStatus(status) == JobStatus.SUCCEEDED:
            self.log.info("Job %s completed successfully.",
                          self.airbyte_job_id)
            return True
